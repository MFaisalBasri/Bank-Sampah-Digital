    ...
    if(isset($_POST['simpan'])){
      ...
      if (mysqli_fetch_array($sql) > 0) {
         echo "<script>
               ...
               content='0; url=http://localhost/project-web/Bank%20Sampah%20Digital/system/models/login/registrasi.php'>";
      ...
      echo "<meta http-equiv='refresh'
      content='0; url=http://localhost/project-web/Bank%20Sampah%20Digital/system/models/login/login.php'>";
    }
...
<body>
	   <h2 style="font-size: 30px; color: #262626;">Registrasi Admin</h2>
